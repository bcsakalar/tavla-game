...
class BearingOffTrayWidget extends StatelessWidget {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            // Inset shadow effect (outer dark shadow simulating depth)
            BoxShadow(
            ...
            if (isValidTarget)
              BoxShadow(
                color: TavlaTheme.success.withValues(alpha: 0.5),
                blurRadius: 10,
                spreadRadius: 2,
              ),
            // Active subtle glow
        ...
        child: Stack(
          children: [
            // Inner shadow overlay (simulates recessed slot)
            Positioned.fill(
              child: Container(
                decoration: BoxDecoration(
            ...
            Column(
              children: [
                ...
                // Stacked pieces (tilted/overlapping for realism)
                Expanded(
